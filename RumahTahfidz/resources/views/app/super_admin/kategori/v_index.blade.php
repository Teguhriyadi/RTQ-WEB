                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button onclick="editDataKategori({{ $kategori->id }})" class="btn btn-warning" data-target="#modalEdit" data-toggle="modal">
                                                <i class="fa fa-edit"></i> Edit
                                            </button>
                                            <button id="deleteKelas" data-id="{{ $kategori->id }}" class="btn btn-danger">
