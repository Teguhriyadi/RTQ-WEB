                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button onclick="editDataKategori({{ $kategori->id }})" class="btn btn-warning btn-sm" data-target="#modalEdit" data-toggle="modal">
                                                <i class="fa fa-edit"></i> Edit
                                            </button>
                                            <button id="deleteKelas" data-id="{{ $kategori->id }}" class="btn btn-danger btn-sm">
        ...
        $('body').on('click', '#deleteKelas', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    form_string = "<form method=\"POST\" action=\"{{ url('/app/sistem/kategori/') }}/"+id+"\" accept-charset=\"UTF-8\"><input name=\"_method\" type=\"hidden\" value=\"DELETE\"><input name=\"_token\" type=\"hidden\" value=\"{{ csrf_token() }}\"></form>"
