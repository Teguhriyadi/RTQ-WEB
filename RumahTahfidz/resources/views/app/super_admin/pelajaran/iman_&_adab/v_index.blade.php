...
@section("app_title", "Pelajaran Iman & Adab")
...
<div class="row">
    <div class="col-md-4 col-sm-8 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form method="POST" action="{{ url('/app/sistem/pelajaran/iman_adab') }}">
                    @csrf
                            ...
                            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                                ...
                                <tbody>
                                    @php
                                        $no = 0
                                    @endphp
                                    @foreach ($data_pelajaran_iman_adab as $data)
                                    <tr>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true" id="modalEdit">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ url('/app/sistem/pelajaran/iman_adab/simpan') }}" method="POST">
                @method("PUT")
                @csrf
...
<script>
    function editPelajaranImanAdab(id) {
        $.ajax({
            url : "{{ url('/app/sistem/pelajaran/iman_adab/edit') }}",
            type : "GET",
            data : { id : id },
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '#deletePelajaranImanAdab', function () {
            let id = $(this).data('id');
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    form_string = "<form method=\"POST\" action=\"{{ url('/app/sistem/pelajaran/iman_adab/') }}/"+id+"\" accept-charset=\"UTF-8\"><input name=\"_method\" type=\"hidden\" value=\"DELETE\"><input name=\"_token\" type=\"hidden\" value=\"{{ csrf_token() }}\"></form>"
