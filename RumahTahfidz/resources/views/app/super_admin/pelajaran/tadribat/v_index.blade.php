                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button onclick="editDataPelajaranTadribat({{ $data->id }})" class="btn btn-warning btn-sm" data-target="#modalEdit" data-toggle="modal">
                                                <i class="fa fa-edit"></i> Edit
                                            </button>
                                            <button id="deletePelajaranTadribat" data-id="{{ $data->id }}" class="btn btn-danger btn-sm">
