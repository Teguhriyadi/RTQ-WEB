                            ...
                            <table id="datatable" class="table table-striped table-bordered" style="width: 100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $data->sekolah }}</td>
                                        <td class="text-center">{{ $data->prestasi_anak }}</td>
                                        <td>{{ $data->getWali->getUser->nama }}</td>
                                        <td>{{ $data->getJenjang->jenjang }}</td>
                                        <td class="text-center">
                                            <button onclick="editTesSantri({{ $data->id }})" type="button" class="btn btn-warning" id="btnEdit" data-target="#modalEdit" data-toggle="modal">
